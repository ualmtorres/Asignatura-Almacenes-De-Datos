...
* Grupo docente: 13 sesiones presenciales = 26 horas.
** Aula 16 - Aulario IV. Jueves de 16h a 18h

* Grupos de trabajo: 10 sesiones presenciales = 20 horas.
** A2: Aula 11 - Aulario V (Aulas de Informática). Lunes de 18h a 20h
** A1: Aula 11 - Aulario V (Aulas de Informática). Jueves de 18h a 20h

* https://docs.google.com/document/d/10pIhD9qRzVqlHihyW-6VFIlvNQRG2AYiqhOA-Knk_UA/edit?usp=drive_link[Planificación de la asignatura, window=_blank]

Profesores:

* Manuel Torres Gil
** Tutorías: Lunes y Jueves de 11h a 14h. Solicitar cita previa
...
* Lab04
** https://docs.google.com/presentation/d/1zJXggCnZie2KOFWSYPjrEgnzHYygiaSTelxvWXgL5wo/edit?usp=sharing[Presentación: Introducción a Microsoft Fabric, window=_blank]
