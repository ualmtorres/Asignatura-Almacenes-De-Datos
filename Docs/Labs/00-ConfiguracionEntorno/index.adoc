...
[NOTE]
====
Si aparece un mensaje indicando que no se puede verificar si es estudiante, hacer clic sobre el enlace proporcionado para verificar el estado de estudiante. Esto abrirá una nueva ventana en la que se debe introducir los datos personales esenciales de la cuenta de estudiante. Una vez verificado el estado de estudiante, se podrá solicitar la suscripción gratuita.
====
...
[NOTE]
====
Si la cuenta de Azure ya estuvo activa durante el curso anterior, es posible que haya que renovar la suscripción gratuita. En ese caso, aparecerá un mensaje indicando que la suscripción ha expirado y se deberá hacer clic en el enlace proporcionado para renovar la suscripción gratuita.
====
